...
// extends- is the keyword for inheriting parent class
class User extends Database
{
    ...
    public function login($request)
    {
        ...
        if($result = $this->conn->query($sql))
        {
            ...
            {   
                // num_rows if a mysql property the hold the number of rows selected from the database
                ...
                {   
                    ...
                    $_SESSION['fullname'] = $user_details['first_name']. " " . $user_details['last_name'];
    ...
    public function update($request, $files){
        ...
        if($this->conn->query($sql)){
            ...
            if($photo)
            {
                // second sql command for updating only the photo
